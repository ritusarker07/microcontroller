...
;SevenSEGME.c,3 :: 		void main() {
;SevenSEGME.c,4 :: 		TRISB = 0x00;
0x002C	0x1683      	BSF        STATUS, 5
0x002D	0x0186      	CLRF       TRISB
;SevenSEGME.c,5 :: 		PORTB = 0x00;
0x002E	0x1283      	BCF        STATUS, 5
0x002F	0x0186      	CLRF       PORTB
;SevenSEGME.c,6 :: 		while(1){
L_main0:
;SevenSEGME.c,7 :: 		for(i = 0; i < 10; i++){
0x0030	0x01AC      	CLRF       _i
0x0031	0x01AD      	CLRF       _i+1
L_main2:
0x0032	0x3080      	MOVLW      128
0x0033	0x062D      	XORWF      _i+1, 0
0x0034	0x00F0      	MOVWF      R0
0x0035	0x3080      	MOVLW      128
0x0036	0x0270      	SUBWF      R0, 0
0x0037	0x1D03      	BTFSS      STATUS, 2
0x0038	0x283B      	GOTO       L__main7
0x0039	0x300A      	MOVLW      10
0x003A	0x022C      	SUBWF      _i, 0
L__main7:
0x003B	0x1803      	BTFSC      STATUS, 0
0x003C	0x2853      	GOTO       L_main3
;SevenSEGME.c,8 :: 		PORTB = arr[i];
0x003D	0x082C      	MOVF       _i, 0
0x003E	0x3E20      	ADDLW      _arr
0x003F	0x0084      	MOVWF      FSR
0x0040	0x0800      	MOVF       INDF, 0
0x0041	0x0086      	MOVWF      PORTB
;SevenSEGME.c,9 :: 		Delay_ms(100);
0x0042	0x3002      	MOVLW      2
0x0043	0x00FB      	MOVWF      R11
0x0044	0x3004      	MOVLW      4
0x0045	0x00FC      	MOVWF      R12
0x0046	0x30BA      	MOVLW      186
0x0047	0x00FD      	MOVWF      R13
L_main5:
0x0048	0x0BFD      	DECFSZ     R13, 1
0x0049	0x2848      	GOTO       L_main5
0x004A	0x0BFC      	DECFSZ     R12, 1
0x004B	0x2848      	GOTO       L_main5
0x004C	0x0BFB      	DECFSZ     R11, 1
0x004D	0x2848      	GOTO       L_main5
0x004E	0x0000      	NOP
;SevenSEGME.c,7 :: 		for(i = 0; i < 10; i++){
0x004F	0x0AAC      	INCF       _i, 1
0x0050	0x1903      	BTFSC      STATUS, 2
0x0051	0x0AAD      	INCF       _i+1, 1
;SevenSEGME.c,10 :: 		}
0x0052	0x2832      	GOTO       L_main2
L_main3:
;SevenSEGME.c,11 :: 		}
0x0053	0x2830      	GOTO       L_main0
;SevenSEGME.c,12 :: 		}
L_end_main:
0x0054	0x2854      	GOTO       $+0
; end of _main
Symbol List:
//** Routines locations **
